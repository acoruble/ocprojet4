...
<?php
  ...
  require_once('php/Billets.php');
  require_once('php/BilletsManager.php');
?>
      ...
      <div class="row">
        <div class="col-3 col-md-3 bg-primary rounded border-0 shadow-lg">
          ...
          <ul class="nav nav-pills flex-column">
            <?php
            $reponse = $_db->query('SELECT ID, titre FROM billets ORDER BY ID');
        ...
        <div class="col-md-9 border rounded bg-primary shadow-lg" style="">
          ...
          $reponse = $_db->query('SELECT ID FROM billets ORDER BY ID LIMIT 0,1');
          $premierID = $reponse->fetch();
          $reponse->closeCursor();

          $reponse = $_db->query("SELECT ID FROM billets ORDER BY ID DESC LIMIT 0,1");
          ...
          $req = $_db->prepare('SELECT titre, contenu FROM billets WHERE ID=? LIMIT 0,1 ');
    ...
    <div class="container">
        ...
        <div class="col-md-12 my-5 shadow-lg rounded-top" style="">
          ...
          <div class="col-md-12" style="">
            ...
            if (isset($_POST["pseudo"])) {
              $req = $_db->prepare('INSERT INTO commentaires(titreChapitre, pseudo, date, message, nbSignalement) VALUES (?,?,?,?,0)');
      ...
      <div class="row">
        <div class="col-md-12 bg-primary rounded-bottom py-2 shadow-lg text-center" style="">
          ...
          <?php
          $req = $_db->prepare('SELECT ID, pseudo, date, message FROM commentaires WHERE titreChapitre = ?');
          ...
          if (isset($_POST["nbSignalementCommentaire"])) {
            $req = $_db->prepare('SELECT nbSignalement FROM commentaires WHERE ID = ?');
            $req-> execute(array($_POST["IDCommentaire"]));
            while ($donnees = $req->fetch())
            {
              $nouveauNbSignalement=$donnees["nbSignalement"]+1;
              $req = $_db->prepare('UPDATE commentaires SET nbSignalement = :nbSignalement WHERE  ID = :IDCommentaire');
              $req->execute(array(
